...
from plugins import crop_by_cycle
...
def test_crop_1() -> None:
    clear_cloud: o3d.cpu.pybind.geometry.PointCloud = crop_by_cycle(
...
def test_crop_2() -> None:
    clear_cloud_2: o3d.cpu.pybind.geometry.PointCloud = crop_by_cycle(
...
def test_crop_3() -> None:
    clear_cloud_3: o3d.cpu.pybind.geometry.PointCloud = crop_by_cycle(
...
def test_crop_4() -> None:
    clear_cloud_4: o3d.cpu.pybind.geometry.PointCloud = crop_by_cycle(
        ply_file, -3.0, 3.0, 13.0, -13.0
    )
...
def test_crop_5() -> None:
    clear_cloud_5: o3d.cpu.pybind.geometry.PointCloud = crop_by_cycle(
        ply_file, 3.0, -3.0, -13.0, 13.0
    )
...
def test_crop_6() -> None:
    clear_cloud_6: o3d.cpu.pybind.geometry.PointCloud = crop_by_cycle(
        ply_file, -3.0, 3.0, -13.0, 13.0
    )
...
def test_crop_7() -> None:
    clear_cloud_7: o3d.cpu.pybind.geometry.PointCloud = crop_by_cycle(

...
def crop_by_box(data: o3d.geometry.PointCloud, crop_rx: float, crop_lx: float, crop_fy: float, crop_by: float) -> o3d.geometry.PointCloud:
    """
        ...
        :return: PointCloud
        """
    box: o3d.geometry.AxisAlignedBoundingBox = data.get_axis_aligned_bounding_box()

...
def sewing_the_holes(pc: o3d.geometry.PointCloud, radius: float) -> o3d.geometry.PointCloud:
    pc.estimate_normals()
    ...
    mesh: open3d.geometry.TriangleMesh = o3d.geometry.TriangleMesh.create_from_point_cloud_ball_pivoting(pc, o3d.utility.DoubleVector([radius, radius * 2]))
    filled = o3d.t.geometry.TriangleMesh.from_legacy(mesh).fill_holes(radius).to_legacy()

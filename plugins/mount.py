...
def mount(data: o3d.geometry.PointCloud, picture_path: str) -> o3d.geometry.PointCloud:
    ...
    rgbd_image = o3d.geometry.RGBDImage.create_from_color_and_depth(image_data, data, depth_scale = 1.0, convert_rgb_to_intensity=False)
    cloud_result = o3d.geometry.PointCloud.create_from_rgbd_image(rgbd_image, o3d.camera.PinholeCameraIntrinsicParameters.PrimeSenseDefault)

...
def test_clear_1() -> None:
    clear_cloud: o3d.cpu.pybind.geometry.PointCloud = clear(ply_file, -3.0, "Above")
...
def test_clear_2() -> None:
    clear_cloud_2: o3d.cpu.pybind.geometry.PointCloud = clear(ply_file, -3.0, "Below")
...
def test_clear_3() -> None:
    clear_cloud_3: o3d.cpu.pybind.geometry.PointCloud = clear(ply_file, 3.0, "Below")
...
def test_clear_4() -> None:
    clear_cloud_4: o3d.cpu.pybind.geometry.PointCloud = clear(ply_file, 100.0, "Above")

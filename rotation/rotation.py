...
def rotation_matrix_func(string: str, rotate_x: float, rotate_y: float, rotate_z: float) -> list[float]:
...
def rotate_file(point_cloud: list, string: str, rotate_x: float, rotate_y: float, rotate_z: float):
...
if __name__ == "__main__":
    ...
    new_file = rotate_file(pc_np, "Degree", 90, 0, 0)
